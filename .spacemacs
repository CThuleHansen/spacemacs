...
This is the place where most of your configurations should be done. Unless it is
 explicitly specified that a variablould be set before a package is loaded,
yo place your code here."
 (fset 'evil-visual-update-x-selection 'ignore) 
  ...
  ;; Go down logical lines https://github.com/syl20bnr/spacemacs/issues/9557
  ...
  (add-hook 'pdf-view-mode-hook (lambda ()
                                  ...
                                  (define-key pdf-view-mode-map (kbd "C-w <left>") 'evil-window-left)
                                  (define-key pdf-view-mode-map (kbd "C-w <right>") 'evil-window-right)
                                  (define-key pdf-view-mode-map (kbd "C-w <up>") 'evil-window-up)
                                  (define-key pdf-view-mode-map (kbd "C-w <down>") 'evil-window-down)
                                  ))
